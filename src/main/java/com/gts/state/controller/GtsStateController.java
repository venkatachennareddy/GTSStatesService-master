...
public class GtsStateController {
	...
	public ResponseEntity<String> deleteGtsState(@RequestBody GtsState gtsState){
		...
		return new ResponseEntity<>(gtsStateService.deleteGtsState(gtsState.getGtsStateId()),HttpStatus.OK);
